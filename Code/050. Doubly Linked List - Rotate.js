...
class DoublyLinkedList {
    ...
    reverse() {
        ...
        for (let i = 0; i < this.length; i++) {
            ...
            if (newHead) newHead.previous = currentNode;
            newHead = currentNode;
            currentNode = next;
        }
...
// null <- Good Bye! -> <- How are you mate? -> <- Hello -> null
console.log(list.rotate(-2));
// null <- How are you mate? -> <- Hello -> <- Good Bye! -> null
list.insert(0, list.remove(1).val);
// null <- Hello -> <- How are you mate? -> <- Good Bye! -> null
console.log(list);