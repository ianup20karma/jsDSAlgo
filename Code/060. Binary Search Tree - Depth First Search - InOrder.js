...
class BinarySearchTree {
    ...
    // Starting from left node We store the bottom most node values first then the root node and then the right ones.
...
console.log(BST.depthFirstSearchInOrder()); // [ 2,  5,  7, 10, 11, 13, 16 ]
console.log(BST);
