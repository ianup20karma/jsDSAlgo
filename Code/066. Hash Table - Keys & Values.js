...
console.log(hashTable.keys()); // [ 'yellow', 'olive', 'maroon', 'salmon', 'plum', 'lightcoral', 'mediumvioletred' ]
console.log(hashTable.values()); // [ '#FFFF00', '#808000', '#800000', '#FA8072', '#DDA0DD', '#F08080', '#C71585' ]